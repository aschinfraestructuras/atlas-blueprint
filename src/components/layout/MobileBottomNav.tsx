...
import {
  ...
  ClipboardList, Clock, X, CalendarCheck,
} from "lucide-react";
...
const PRIMARY_ITEMS: NavItem[] = [
  ...
  { labelKey: "nav.ppi",             icon: ClipboardCheck,  route: "/ppi",             matchPrefixes: ["/ppi"] },
...
export function MobileBottomNav() {
  ...
  const isMoreActive = MORE_ITEMS.some(isActive);
  ...
  return (
    <>
      ...
      {/* Drawer "Mais" — desliza de baixo para cima, acima da barra */}
      <div
        ref={drawerRef}
        className={cn(

...
const makeSchema = (t: (k: string) => string) =>
  z.object({
    ...
    // code is optional — auto-generated by DB fn if empty
  ...
  async function onSubmit(values: FormValues) {
    ...
    try {
      ...
      const input = {
        ...
        // Empty string → DB function auto-generates code as PPI-{CODE}-{0001}
      ...
      <DialogContent className="sm:max-w-[520px]">
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            ...
            {disciplineMismatch && (
              <Alert className="border-amber-300/60 bg-amber-50 dark:bg-amber-900/10 py-2">
